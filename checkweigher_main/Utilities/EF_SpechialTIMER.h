...
* Return Value: None.
******************************************************************************/
extern void EF_void_TimerCreate(U8_t timerNumber , U32_t timerTimeout);
...
* Return Value: None.
******************************************************************************/
extern void EF_void_TimerReset(U8_t timerNumber);


extern void EF_void_Timer_TurnOff(U8_t timerNumber);
#endif
